...
\begin{equation*}
        T = \max \left\{
                \sin \left( \frac{i}{\alpha_2} \right) \cdot scale + 2 scale ,
                T_{min}
        \right\}
\end{equation*}
...
\begin{figure*}[ht]
        \caption{Performance profile of the sinusoidal tabu search on the parameters $\left(\alpha_0, \alpha_1\right)$}
        \label{fig:ht_sinten}
        \centering
        \includegraphics[width=340pt]{assets/ht_greedy.pdf}
\end{figure*}
