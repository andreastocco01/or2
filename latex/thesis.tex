...
In this section we will explore another set of techniques that we will call
\textit{matheuristics}.
...
of the approaches that have some. Then, we will compare methods among them, searching for the
best one.

Naturally the main difference we have among the approaches that we present is if we are computing
and optimal solution or we are applying an heuristic. In the former case, the metric we are going
