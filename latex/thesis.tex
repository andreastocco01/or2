...
\subsection{2-opt}
The 2-opt algorithm is an optimization technique that can be used to improve heuristic
algorithm's solutions.
The 2-opt algorithm evaluates the possibility of removing two edges in the tour for reconnecting the nodes in a different order.
...
the solution. This iterative refinement continues until no further improvements can be made, potentially resulting in a more optimal
solution for the given problem instance. (TODO add a picture to better explain this algorithm)
