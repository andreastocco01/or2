...
% TODO more on fractional cuts (speaking of concorde)
...
Fixing too many edges (80\%, 90\%) leads to the worst performance. This may be because
the MIP solver struggles to find a good solution due to the limited degrees of
freedom we allow it. Instead, reducing the problem size by 40\% and hence giving
CPLEX more degrees of freedom leads to the best performance.

\clearpage
\subsubsection{Local branching}

%TODO regenerate plot and add legend
% the number shown is the starting k, delta is always 5
...
%%TODO write explaination of what the different methods are
