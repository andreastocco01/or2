...
tsp_cplex.o: tsp_cplex.h tsp_cplex.c
	$(CC) $(CFLAGS) -I$(CPLEX_INC_DIR) -I$(CPLEX_CONCERT_INC_DIR) -c tsp_cplex.c -o tsp_cplex.o
...
main: main.c tsp.h tsp.o util.h util.o tsp_greedy.h tsp_greedy.o tsp_tabu.h tsp_tabu.o tsp_vns.h tsp_vns.o eventlog.o tsp_cplex.o
	$(CC) $(CFLAGS) -L$(CPLEX_LIB_DIR) -L$(CPLEX_CONCERT_LIB_DIR) tsp.o util.o tsp_greedy.o tsp_tabu.o tsp_vns.o eventlog.o tsp_cplex.o main.c $(LINK) $(CPLEX_LIBS) -o main
